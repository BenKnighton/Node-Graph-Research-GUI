...
if __name__ == '__main__':
    ...
    graph = NodeGraph()
    graph.set_grid_color(34, 54, 73)
    graph.set_grid_color(15, 34, 46)
    # graph.set_grid_color(0, 44, 62)
    
    graph.set_background_color(0, 4, 7)
    # graph.set_background_color(16, 22, 28) #batman
    # graph.set_background_color(13, 23, 39) #blue
    # graph.set_background_color(13, 17, 18) #blue
    # graph.set_background_color(34, 51, 73) lightest
    ...
    graph.register_nodes([
        ...
        custom_ports_node.ImageNodeH,
        custom_ports_node.ImageNodeV,
        custom_ports_node.ScrollNode,
        group_node.MyGroupNode,
        # widget_nodes.DropdownMenuNode,
        widget_nodes.TextInputNode,
        widget_nodes.CheckboxNode,
        # widget_nodes.ButtonNode,
        widget_nodes.TitleNode

    ])

    # show the node graph widget.
    graph_widget = graph.widget
    graph_widget.resize(1440, 900)
    graph_widget.setWindowTitle("KNIGHTON WORKSPACE")
    graph_widget.show()
    ...
    #     'nodes.basic.BasicNodeC', text_color='#feab20')
    # n_basic_c.set_disabled(True)
    ...
    n_backdrop.wrap_nodes([n_custom_ports, n_checkbox])
