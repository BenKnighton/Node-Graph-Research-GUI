...
class ViewerEnum(Enum):
    ...
    BACKGROUND_COLOR = (35, 35, 35) #tab x1
    ...
    GRID_SIZE = 50
    #: grid line color.
    GRID_COLOR = (45, 45, 45) #highnlight
...
class ViewerNavEnum(Enum):
    ...
    BACKGROUND_COLOR = (25, 25, 25) #background box colour x1
    #: default item color.
    ITEM_COLOR = (35, 35, 35) #highlight colour over itmes
