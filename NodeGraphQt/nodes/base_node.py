...
class BaseNode(NodeObject):
    ...
    **Inherited from:** :class:`NodeGraphQt.NodeObject`
    ...
    def add_button(self, name, label='', text='button', tab=None):
        """
        Creates a custom property with the :meth:`NodeObject.create_property`
        function and embeds a :class:`PySide2.QtWidgets.QLineEdit` widget
        into the node.
        ...
        """
        self.create_property(
            name, text, widget_type=NODE_PROP_BUTTON, tab=tab)
    ...
    def add_image(self, name, label='', text='button', tab=None):
        """
        Creates a custom property with the :meth:`NodeObject.create_property`
        function and embeds a :class:`PySide2.QtWidgets.QLineEdit` widget
        into the node.
        ...
        widget = NodeImage(self.view, name, label, text)
        # widget.value_changed.connect(lambda k, v: self.set_property(k, v))
        self.view.add_widget(widget)



    def add_title(self, name, label='', text='title', tab=None):
        """
        Creates a custom property with the :meth:`NodeObject.create_property`
        function and embeds a :class:`PySide2.QtWidgets.QLineEdit` widget
        into the node.
        ...
        self.create_property(
            name, text, widget_type=NODE_PROP_QLABEL, tab=tab)
        widget = NodeTitle(self.view, name, label, text)
        # widget.value_changed.connect(lambda k, v: self.set_property(k, v))
        self.view.add_widget(widget)
    ...
    def add_scrolltext(self, name, label='', text='button', tab=None):
        """
        Creates a custom property with the :meth:`NodeObject.create_property`
        function and embeds a :class:`PySide2.QtWidgets.QLineEdit` widget
        into the node.
        ...
        """
        self.create_property(
            name, text, widget_type=NODE_SCROLL, tab=tab)
        widget = NodeScrollText(self.view, name, label, text)
        # widget.value_changed.connect(lambda k, v: self.set_property(k, v))
        self.view.add_widget(widget)
