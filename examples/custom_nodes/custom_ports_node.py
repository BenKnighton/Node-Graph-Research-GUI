...
class CustomPortsNode(BaseNode):
    ...
    def __init__(self):
        ...
        self.add_output('a')
        self.add_output('b', painter_func=draw_square_port)
        self.add_output('c', painter_func=draw_triangle_port)
...
class ImageNodeV(BaseNode):
    ...
    def __init__(self):
        ...
        # create input and output port.
        self.add_input('in', color=(0, 100, 200))
        self.add_input('m in', multi_input=True)
        self.add_input('a', painter_func=draw_square_port)
        self.add_input('a 2', painter_func=draw_square_port)
        self.add_input('b', painter_func=draw_triangle_port)
        self.add_input('b 2', painter_func=draw_triangle_port)

        self.add_output('out', color=(0, 100, 200))
        self.add_output('m out', multi_output=True)
        self.add_output('a', painter_func=draw_square_port)
        self.add_output('a 2', painter_func=draw_square_port)
        self.add_output('b', painter_func=draw_triangle_port)
        self.add_output('b 2', painter_func=draw_triangle_port)
